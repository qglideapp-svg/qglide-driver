...
class CompletedRideDetailsView extends StatefulWidget {
  ...
  @override
  State<CompletedRideDetailsView> createState() =>
      _CompletedRideDetailsViewState();
}

class _CompletedRideDetailsViewState extends State<CompletedRideDetailsView> {
    ...
    return Scaffold(
      ...
      body: Align(
        ...
        child: ConstrainedBox(
          ...
          child: _isLoading
              ? const _LazyRideDetailsContent()
              : _errorMessage != null
                  ? _RideDetailsErrorState(
                        ...
                        children: [
                          ...
                          _DetailsCard(
                            ...
                            children: [
                              _StatusRow(
                                label: 'Status',
                                status: _details!.statusDisplay,
                                isCompleted: _details!.isCompleted,
                              ),
                              _DetailRow(
                                label: 'Trip ID',
                                value: _details!.tripIdDisplay,
                              ),
                              _DetailRow(
                                label: 'Date',
                                value: _details!.dateDisplay,
                              ),
                              _DetailRow(
                                label: 'Total Amount',
                                value: _details!.amountDisplay,
                              ),
                            ],
                          ),
                          ResponsiveGap(14),
                          _DetailsCard(
                            ...
                            children: [
                              _DetailRow(
                                label: 'Pickup:',
                                value: _details!.pickupAddress,
                                multilineValue: true,
                              ),
                              _DetailRow(
                                label: 'Drop off',
                                value: _details!.dropoffAddress,
                                multilineValue: true,
                              ),
                              _DetailRow(
                                label: 'Distance',
                                value: _details!.distanceDisplay,
                              ),
                              _DetailRow(
                                label: 'Duration',
                                value: _details!.durationDisplay,
                              ),
                            ],
                          ),
                          ResponsiveGap(14),
                          _DetailsCard(
                            ...
                            children: [
                              _DetailRow(
                                label: 'Name',
                                value: _details!.riderNameDisplay,
                              ),
                              _DetailRow(
                                label: 'email',
                                value: _details!.riderEmailDisplay,
                              ),
                              _RatingRow(
                                label: 'Ratings',
                                rating: _details!.riderRatingDisplay,
                              ),
                            ],
                          ),
                        ],
...
class _RideDetailsErrorState extends StatelessWidget {
  const _RideDetailsErrorState({
...
class _LazyRideDetailsContent extends StatefulWidget {
  const _LazyRideDetailsContent();

  @override
  State<_LazyRideDetailsContent> createState() =>
      _LazyRideDetailsContentState();
}

class _LazyRideDetailsContentState extends State<_LazyRideDetailsContent>
